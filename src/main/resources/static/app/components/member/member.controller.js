"use strict";
angular.module('sprintGraphApp').controller('MemberCtrl', [ 'MemberService', '$stateParams', '$timeout','$uibModal', 'rx', 'AbsenceService', function(memberService, $stateParams, $timeout,$uibModal,rx,absenceService) {
	var vm = this;
	this.member = {};
	this.absences = [];
